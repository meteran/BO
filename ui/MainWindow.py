...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stop_computing_button = QtGui.QPushButton(self.splitter_3)
        self.stop_computing_button.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.stop_computing_button.setFont(font)
        self.stop_computing_button.setObjectName(_fromUtf8("stop_computing_button"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.stop_computing_button.setText(_translate("MainWindow", "stop", None))
